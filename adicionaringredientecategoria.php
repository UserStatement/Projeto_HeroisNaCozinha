  ...
  <body>
    <div id="page">
      ...
      <div id="body">
        ...
        <br><br>
				<form action="adicionaringredientecategoria_db.php" method="POST">


                    <table>
                        <th>
                            <td><label>Nome da categoria</label></td>
                        </th>
                        <tr>
                            <td><input type="text" name="ingredienteCategoria" placeholder="Categoria do ingrediente">
                            </td>   
                        </tr>
                    </table>
				    ...
				    <input type="submit" name="Adicionar  Ingredient" value="Adiciona categoria">
